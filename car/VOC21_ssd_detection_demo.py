...
caffe_root="/home/zhaoyanzhu/caffe-ssd/"
import sys
...
if __name__ == '__main__':
    ...
    labelmap_file = '../data/VOC21/labelmap_voc.prototxt'
    ...
    model_def = '../models/VGGNet/VOC21/SSD_500x500/deploy.prototxt'
    model_weights = '../models/VGGNet/VOC21/SSD_500x500/VGG_VOC21_SSD_500x500_iter_20000.caffemodel'
	...
	# Folder of images
    image_dir = '/home/zhaoyanzhu/caffe-ssd/data/VOC21devkit/VOC-21/JPEGImages/';

	# List of images
    im_list = '/home/zhaoyanzhu/caffe-ssd/data/VOC21devkit/VOC-21/jpglist.txt';
    ...
    print ('Detection took {:.3f}s for '
           '{:d} images').format(timerO.total_time, count)
